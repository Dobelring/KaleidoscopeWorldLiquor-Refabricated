...
public abstract class CreativeModeTabsMixin {
   ...
   private static List<CreativeModeTab> kwl$moveTavernTabsAfterLiquor(List<CreativeModeTab> tabs) {
      CreativeModeTab ourTab = BuiltInRegistries.CREATIVE_MODE_TAB.get(
         ResourceLocation.fromNamespaceAndPath("kaleidoscope_world_liquor", "kaleidoscope_world_liquor_tab")
      );
      CreativeModeTab tavernMain = BuiltInRegistries.CREATIVE_MODE_TAB.get(
         ResourceLocation.fromNamespaceAndPath("kaleidoscope_tavern", "tavern_main")
      );
      CreativeModeTab tavernDeco = BuiltInRegistries.CREATIVE_MODE_TAB.get(
         ResourceLocation.fromNamespaceAndPath("kaleidoscope_tavern", "tavern_deco")
      );
