...
public final class ModRecipes {
    ...
    public static final RecipeSerializer<FreezerRecipe> FREEZER_SERIALIZER =
            new RecipeSerializer<>(FreezerRecipeSerializer.CODEC, FreezerRecipeSerializer.STREAM_CODEC);
