...
## Compat
- **JEI / EMI**: view freezer recipes (shaker / barrel / pressing tub recipes are provided by Kaleidoscope Tavern itself).
...
## Build
Targets **Minecraft 1.21.1 (Fabric)** — branch `1.21.1-fabric`. Requires **JDK 21**.
